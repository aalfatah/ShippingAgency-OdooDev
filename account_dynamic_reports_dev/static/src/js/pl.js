odoo.define('account_dynamic_reports_dev.pl', function(require) {
    'use strict';
        ...
        print_pdf : function(e){
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'report_name': 'account_dynamic_reports_dev.partner_ledger',
                    'report_file': 'account_dynamic_reports_dev.partner_ledger',
                    'data': {'js_data':data},
    ...
    core.action_registry.add('dynamic_pl', DynamicPlMain);
