odoo.define('account_dynamic_reports_dev.gl', function(require) {
    'use strict';
    ...
    var DynamicGlMain = AbstractAction.extend({
        ...
        print_pdf : function(e){
            ...
            args: [[self.wizard_id]],
                ...
                var action = {
                    ...
                    'report_name': 'account_dynamic_reports_dev.general_ledger',
                    'report_file': 'account_dynamic_reports_dev.general_ledger',
                    'data': {'js_data':data},
        ...
        fetch_move_lines_by_page : function(event){
            // console.log('============================================================ click line by page')
        ...
        fetch_move_lines : function(event){
            // console.log('================================== click fetch_move_lines')
            event.preventDefault();
            var self = this;
            var account_id = $(event.currentTarget).data('account-id');
            var offset = 0;
    ...
    core.action_registry.add('dynamic_gl', DynamicGlMain);
